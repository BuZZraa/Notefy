  ...
  return (
    <div>
      ...
      {testimonials.map(testimonial => (
        <div key={testimonial.id} className="bg-gray-50 p-4 rounded-lg shadow-md mb-4">
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <div className="max-w-4xl w-full p-8 bg-white rounded-lg shadow-lg">
        ...
        <p className="text-gray-700 mb-4 text-justify">
          Our notes app is designed to help you organize your thoughts, ideas, tasks, and more.
          Whether you're a student, professional, or just someone who loves jotting down
          notes, our app provides a simple yet powerful platform to keep your notes organized
          and accessible from anywhere.
        </p>
        <KeyFeatures />
        <p className="text-gray-700 mb-4 text-justify">
          We are committed to continuously improving our app to meet the evolving needs of
          our users. Your feedback is invaluable to us, so please don't hesitate to reach out
          with any suggestions or questions.
        </p>
        <Testimonials />
        <p className="text-gray-700 mb-4 text-justify">
          Thank you for choosing our notes app to accompany you on your journey of productivity
          and creativity!
        </p>
