        ...
        <>
            ...
            <div className="w-[35rem] mt-16 border-solid border-2 border-stone-400 h-fit p-8 rounded-md">
                ...
                <menu className="flex items-center justify-center gap-4 my-4">
                    <li>
                        <button 
                            className="px-6 py-2 rounded-md text-red-600 border-2 border-solid border-red-600 hover:bg-red-600 hover:text-stone-100"
                            ref={cancelButtonRef}
                            onClick={onCancel}>
                            Cancel
                        </button>
                    </li>
                    <SpeechToTextConverter onCommand={handleCommand} />
                    <li>
                        <button                           
                            className="px-6 py-2 rounded-md text-green-600 border-2 border-solid border-green-600 hover:bg-green-600 hover:text-stone-100"
                            onClick={handleSave}>
                            Save
                        </button>
                    </li>
