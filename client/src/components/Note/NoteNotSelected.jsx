...
function NoteNotSelected({onStartAddProject}) {
    return(
        <div className="mt-24 text-center w-2/3">
            ...
            <h2 className="text-xl font-bold text-stone-500 my-4">Select a Note to view</h2>
            <p className="text-stone-400 mb-4">Click on a note from the list to see its details and contents.</p>
            <p className="mt-8">
